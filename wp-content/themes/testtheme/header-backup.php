		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					...
					<!--
					====================================================================
					Example code Bootstrap https://getbootstrap.com/components/#navbar
					====================================================================
					-->
					...
					<!--
					====================================================================
					End example code Bootstrap https://getbootstrap.com/components/#navbar
					====================================================================
					-->

					<?php wp_nav_menu(array('theme_location'=>'primary')); // var_dump(get_custom_header()) ?>
				</div>
			</div>
